...
var DocumentsApi = (function () {
    function DocumentsApi(http, basePath) {
        this.http = http;
     ...
     * @param body
     */
    DocumentsApi.prototype.addDocuments = function (body, extraHttpRequestParams) {
        var path = this.basePath + '/documents';
     ...
     * @param entityId
     */
    DocumentsApi.prototype.listDocuments = function (entityType, entityId, extraHttpRequestParams) {
        var path = this.basePath + '/documents';
        var queryParameters = new http_1.URLSearchParams();
        var headerParams = this.defaultHeaders;
