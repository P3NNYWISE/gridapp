...
export class CommentsApi {
     ...
     * @param body 
     */
    public addComment (body?: models.Comment, extraHttpRequestParams?: any ) : Observable<models.Comment> {
     ...
     * @param entityId 
     */
    public listComments (entityType?: string, entityId?: string, extraHttpRequestParams?: any ) : Observable<Array<models.Comment>> {
        const path = this.basePath + '/comments';
